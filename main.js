jQuery(document).ready(function ($) {
  ...
  var snakeorladderobj = {
    "row1 col5": { type: '1', end: 'row2 col4' },
    "row3 col3": { type: '0', end: 'row1 col2' },
    "row4 col1": { type: '0', end: 'row3 col2' },
    "row5 col1": { type: '0', end: 'row4 col4' },
    "row4 col3": { type: '1', end: 'row5 col4' }
  };
  ...
  var prestartGame = function (avatar, who_first) {
    ...
    main_container.append('<img data-currentboxrowcol="row1 col1" data-currentboxno="1" class="player_in_board player' + first_player + '" src="avatar_body' + first_player + '.png" alt="player1" style="top:' + top + 'px;left:' + left + 'px">');
    startTheGame();
  };
  ...
  var endGame = function () {
    ...
    for (var i = 0; i < both_players.length; i++) {
      ...
      if ($(self).attr("data-currentboxno") == 25) {
        ...
        var temp2 = { "one": "1", "two": "2" };

        if (who_won_temp.match(/\d+/) == temp2[my_avatar]) {
          has_my_avatar_won = true;
        }

        $(".which-avatar-won").attr("src", "avatar" + temp2[my_avatar] + ".png");
  ...
  var movePlayer2toStart = function () {
    if (flag) {
      ...
      var top = box1.top + 10;
      var left = box1.left + 3;
      main_container.append('<img data-currentboxrowcol="row1 col1" data-currentboxno="1" class="player_in_board player' + second_player + '" src="avatar_body' + second_player + '.png" alt="player2" style="top:' + top + 'px;left:' + left + 'px">');
      flag = false;
    }
  };
